...
import { mobileRepository, supabase, supabaseConfigError } from './src/lib/supabase';
...
export default function App() {
  ...
  const screen = useMemo(() => {
    if (supabaseConfigError) return <StateView title="Supabase configuration required" message={supabaseConfigError} />;
